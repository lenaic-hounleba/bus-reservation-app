...
<div class="container" style="margin-top:50px; margin-bottom:50px;">
    ...
    <style>
        ...
        /* petite mise en forme responsive si besoin */
        @media (max-width: 576px) {
            .news-card { border-radius: 6px; }
        }
    </style>

    <h1 class="text-center fw-bold mb-4 news-title">
        <?php echo $titre; ?>
    </h1>
    ...
    <?php if (isset($news)): ?>
        ...
        <div class="card news-card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="fs-5"><?php echo htmlspecialchars($news->act_titre, ENT_QUOTES, 'UTF-8'); ?></div>
                <div class="news-meta small">
                    <span class="me-2">Ajouté le : <?php echo htmlspecialchars($news->act_date_ajout, ENT_QUOTES, 'UTF-8'); ?></span>
                    <span class="badge-accent">ID <?php echo (int)$news->act_id; ?></span>
                </div>
            </div>

            <div class="card-body">
                <p class="card-text mb-0">
                    <?php echo nl2br(htmlspecialchars($news->act_contenu, ENT_QUOTES, 'UTF-8')); ?>
                </p>
            </div>
        </div>
    ...
    <?php else: ?>
        ...
        <div class="alert alert-warning text-center fw-semibold mx-auto" style="max-width:600px;">
            Pas d'actualité correspondante !
        </div>
