                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12 text-light">
                            ...
                            <div class="spacer-double"></div>
                            <h1 class="mb-2">Besoin d'un <span class="id-color">véhicle</span>? Vous êtes au bon endroit.</h1>
...
<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
    ...
    <h2 class="text-center mb-4 fw-bold news-title">
        Nos récentes actualités
    </h2>

    <?php if (!empty($actualites) && is_array($actualites)): ?>

        <table class="table table-bordered" style="background-color: #fff; border: 1px solid #1ECB15 !important; border-radius: 10px !important;">
            <thead class="table-success" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                <tr>
                    <th class="fw-bold">Titre</th>
                    <th class="fw-bold">Contenu</th>
                    <th class="fw-bold">Date de publication</th>
                    <th class="fw-bold">Auteur</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($actualites as $act): ?>
                    <tr class="table-hover" style="background-color: #fff;">
                        <td class="fw-bold text-nowrap"><?php echo htmlspecialchars($act['act_titre'], ENT_QUOTES, 'UTF-8'); ?></td>
                        <td><?php echo nl2br(htmlspecialchars($act['act_contenu'], ENT_QUOTES, 'UTF-8')); ?></td>
                        <td><?php echo htmlspecialchars($act['act_date_ajout'], ENT_QUOTES, 'UTF-8'); ?></td>
                        <td><?php echo htmlspecialchars($act['cpt_pseudo'], ENT_QUOTES, 'UTF-8'); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<style>
    :root { --accent: #1ECB15; --black: #000; --white: #fff; }
    ...
    @media (max-width: 576px) {
        ...
        width: 70%; /* Contenu plus large */
        }

        .table td:nth-child(1), 
        .table td:nth-child(3) {
            width: 15%; /* Titre et Date moins larges */
        }
    }
