...
class Message extends BaseController
{
    ...
    public function verifier()
    {
        ...
        // 1) L’utilisateur arrive pour la première fois → afficher juste le formulaire
        ...
        // 2) Si on arrive ici, c’est que la méthode = POST
        if (! $this->validate(
            [
        ...
        // 3) Le champ est validé → on récupère la valeur
